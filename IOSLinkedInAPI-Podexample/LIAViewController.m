...
- (LIALinkedInHttpClient *)client {
  LIALinkedInApplication *application = [LIALinkedInApplication applicationWithRedirectURL:@"http://oauth.net/2/"
                                                                                  clientId:@"77sufc793vxadw"
                                                                              clientSecret:@"9F1j9cb05W8MwYRF"
